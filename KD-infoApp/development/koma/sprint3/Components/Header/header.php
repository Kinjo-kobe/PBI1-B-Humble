...
<body>
    <div class="bg-gray-800 text-white p-4 flex justify-between items-center">
        <div class="flex items-center space-x-4">
            <img src="../../../..\public\Components\AppIcon\KD-info1.png" alt="KD-info Logo" class="h-8"> <!-- Adjust logo path -->
            <h1 class="text-lg">KD-info</h1>
        </div>
        <div class="flex space-x-4">
            <a href="../posting/postingHome.php" class="$postingClass px-3 py-2 rounded">投稿</a>
